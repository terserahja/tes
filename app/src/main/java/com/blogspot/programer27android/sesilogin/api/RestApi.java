package com.blogspot.programer27android.sesilogin.api;

import com.blogspot.programer27android.sesilogin.model.ResponseData;
...
public interface RestApi {
    ...
    @FormUrlEncoded
    @POST("insert.php")
    Call<ResponseData> senddatauser(@Field("email") String email,
